...
namespace MyCensus.Droid.Renderers
{
    public  class CustomMapRenderer : MapRenderer
    {
        ...
        private readonly BitmapDescriptor _pinIcon;
        private readonly BitmapDescriptor _fromPinIcon;
        private readonly BitmapDescriptor _toPinIcon;
        private readonly List<CustomMarkerOptions> _tempMarkers;
        private readonly bool _isDrawnDone;
