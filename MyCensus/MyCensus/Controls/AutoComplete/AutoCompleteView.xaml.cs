...
namespace MyCensus.Controls.AutoComplete
{
    ...
    public partial class AutoCompleteView : ContentView
    {
        ...
        //SelectedText
        public static readonly BindableProperty SelectedTextProperty = BindableProperty.Create(nameof(SelectedText), typeof(string), typeof(AutoCompleteView), string.Empty);
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            //if (propertyName == SelectedTextProperty.PropertyName)
            //{
            //    SuggestedItemsOuterContainer.s= SelectedText;
            //}
        ...
        private void FilterNotSuggestions(object text, bool openSuggestionPanel = true)
        {
            _availableSuggestions = new ObservableCollection<object>();
            _availableSuggestions.Add(text);
