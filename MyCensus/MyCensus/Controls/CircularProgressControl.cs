...
namespace MyCensus.Controls
{
    public class CircularProgressControl : Grid
    {
        ...
        {
            progress1 = Device.RuntimePlatform == Device.UWP ? CreateImage("Assets/progress_done") : CreateImage("progress_done");
            background1 = Device.RuntimePlatform == Device.UWP ? CreateImage("Assets/progress_pending") : CreateImage("progress_pending");
            background2 = Device.RuntimePlatform == Device.UWP ? CreateImage("Assets/progress_pending") : CreateImage("progress_pending");
            progress2 = Device.RuntimePlatform == Device.UWP ? CreateImage("Assets/progress_done") : CreateImage("progress_done");
