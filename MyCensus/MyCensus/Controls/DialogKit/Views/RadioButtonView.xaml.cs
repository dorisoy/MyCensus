    ...
    public class RadioButton : StackLayout
    {
        ...
        public RadioButton()
        {
            if (Device.RuntimePlatform != Device.iOS)
                lblText.FontSize = lblText.FontSize *= 1.0;
            lblEmpty.FontSize = lblText.FontSize * 1.0;
            lblFilled.FontSize = lblText.FontSize * 1.0;
        ...
        public double FontSize { get => lblText.FontSize; set { lblText.FontSize = value; lblFilled.FontSize = value * 1.0; lblEmpty.FontSize = value * 1.0; } }
        ...
        public static readonly BindableProperty FontSizeProperty = BindableProperty.Create(nameof(FontSize), typeof(double), typeof(RadioButton), 14.0, propertyChanged: (bo, ov, nv) => (bo as RadioButton).FontSize = (double)nv);
