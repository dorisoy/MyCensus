...
namespace MyCensus.Effects
{
    ...
    public static class LineColorEffect
    {
        ...
        {
            public EntryLineColorEffect() : base("MyCensus.EntryLineColorEffect")
            {
            }
        }
        ...
        {
            public DatePickerLineColorEffect() : base("MyCensus.DatePickerLineColorEffect")
            {
            }
        }
        ...
        {
            public PickerLineColorEffect() : base("MyCensus.PickerLineColorEffect")
            {
            }
        }
    }
