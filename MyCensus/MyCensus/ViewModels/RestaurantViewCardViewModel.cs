...
{
	public class RestaurantViewCardViewModel : ViewModelBase, IActiveAware
    {
        ...
        public RestaurantViewCardViewModel(INavigationService navigationService,
        ...
        private async void ViewLocation(object obj)
        {
            ...
            if (Restaurant != null)
            {
                var coordinate = new Coordinate(Restaurant.Latitude, Restaurant.Longitude);
        ...
        private async Task LoadData()
        {
            ...
            var restaurant = await _censusService.GetRestaurant(CurIteamId);
            if (restaurant != null)
            {
                if (restaurant.DoorheadPhotos.FirstOrDefault() != null)
                    ThumbnailPhotoUrl = restaurant.DoorheadPhotos.FirstOrDefault().StoragePath;
