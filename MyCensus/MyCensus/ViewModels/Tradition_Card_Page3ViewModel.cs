...
{
	public class Tradition_Card_Page3ViewModel : ViewModelBase, IActiveAware
    {
            ...
            get
            {
                if (_newAddCmd == null)
                {
                    _newAddCmd = new DelegateCommand<string>(async (r) =>
                    {
                        ...
                        {
                            //"Resolution of the dependency failed, type = 'System.Object', name = 'AddProducts'.\nException occurred while: Calling constructor MyCensus.Views.AddProducts().\nException is: PlatformNotSupportedException - Operation is not supported on this platform.\n-----------------------------------------------\nAt the time of the exception, the container was: \n  Resolving MyCensus.Views.AddProducts,AddProducts (mapped from System.Object, AddProducts)\n  Calling constructor MyCensus.Views.AddProducts()\n"
                        ...
                        using (UserDialogs.Instance.Loading("上传数据中..."))
                        {
                            ...
                            try
                            {
                                ...
                                if (products.Count > 0)
                                {
                                    ...
                                    {
                                        Tradition.SalesProducts.Add(new SalesProduct()
                                        {
                                            Brand = p.Brand,
                                ...
                                try
                                {
                                    ...
                                    {
                                        UserId = Tradition != null ? Tradition.UserId : Settings.UserId.ToString(),
                                        ...
                                        EndPointNumber = Tradition.BaseInfo != null ? Tradition.BaseInfo.EndPointNumber : ""
                                    };

                                    Tradition.TrackLocation = trackLocation;
                                }
                                catch (Exception)
                                {
                                ...
                                //提交数据
                                var result = await _censusService.AddTradition(Tradition);
                                if (result != null)
                                {
